...
!    0.9.0     Hani Ibrahim       2014/04/28 Removed non-standard
!    CLI-functions and added standard F2K CLI-functions
!    1.0.0     Hani Ibrahim       2017/01/07 Parse "=" with long
!    options, error messages to stderr not stdout
!    1.0.1     Hani Ibrahim       2017/09/10 longopt bug fixed
!    1.0.2     Hani Ibrahim       2017/09/29 Readme.md error fixed
!    1.0.3     Hani Ibrahim       2018/07/09 Several errors in Readme.md
!    fixed
!    1.0.4     Hani Ibrahim       2022/03/31 Portable declaration of
!    stdin/out/err fixed, refactoring, documentation
!    1.1.0     Hani Ibrahim       2022/04/10 Utility function "isnum()"
!    added
!
! User routines:
!    getopt, isnum
...
contains
    ...
    !
    ! This is needed because Fortran standard allows but doesn't
    ! *require* short-circuited
    ...
    ! Returns short option character & value (if applicable) of all
    ...
    ! Process short options
        ...
        elseif ( arglen > grpind ) then
            ! no argument (or unrecognised), go to next option in
            ! argument (-xyz)
            grpind = grpind + 1
        else
