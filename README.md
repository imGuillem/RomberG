Prerequisite: Have performed all the calculations in Gaussian. Secondly, have all the fchk files into a folder of the molecule name - all data extraction will be performed from there.
